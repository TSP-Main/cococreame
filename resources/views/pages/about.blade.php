@extends('layout.app')
@section('title', 'CocoCream | About Us')
...
@section('content')
    ...
    <!-- About Section Two -->
    <section class="about-section-two alternate" style="background-image: url({{ asset('theme/images/background/36.jpg') }});">
        <div class="auto-container">
    ...
    <div class="features-section style-two">
        <div class="shape_wrapper shape_one">
            <div class="shape_inner shape_two" style="background-image: url({{ asset('theme/images/background/37.jpg') }});"><div class="overlay"></div></div>
        </div>
    ...
    <!-- Chef Section -->
    <section class="chef-section" style="background-image: url({{ asset('theme/images/background/38.jpg') }});">
        <div class="auto-container">
            <div class="row">
                <div class="content-column col-lg-6 col-md-12 col-sm-12 order-2">
                    <div class="inner-column">                    
                        <div class="content">
                            ...
                            <h4>Masterchef</h4>
                            <div class="divider"><img src="{{ asset('theme/images/icons/icon-devider.png') }}" alt=""></div>
                ...
                <div class="image-column col-lg-6 col-md-12 col-sm-12">
                    <div class="inner-column">
                        <figure class="image"><img src="{{ asset('theme/images/resources/old_man.png') }}" alt=""></figure>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Our Standards -->
    <section class="our-standards" style="background-image: url({{ asset('theme/images/background/39.jpg') }});">
        <div class="auto-container">
            <div class="row">
